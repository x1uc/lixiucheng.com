...
在我的 [第一个月度总结](/retrospectives/2025/11/) 中，我就想写一下每天干了什么，但是一直以来都没有很连贯地执行。
...
OK! Ready is not a Feeling, it is a Decision. 所以这次想法再次冒出来的当天我就去做了。
...
- 观看 300 分钟的英文视频 （观看 500 分钟可达到 A 评级）
- 看完 [TypeScript Documentation](https://www.typescriptlang.org/docs/handbook/intro.html) 的 Handbook 部分
